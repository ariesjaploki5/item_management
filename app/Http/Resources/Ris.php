...
class Ris extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'requested_by' => $this->requested_by !== null ? $this->requested_by->employee->employee_name : " ",
            ...
            'issued_by' => $this->issued_by !== null ? $this->issued_by->employee->employee_name : " ",
            'approved_date' => $this->approved_date !== null ? $this->approved_date->format('d-m-Y') : null,
            'received_by' => $this->received_by !== null ? $this->received_by->employee->employee_name : " ",
